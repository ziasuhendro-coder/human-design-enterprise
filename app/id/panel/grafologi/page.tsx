...
export default function GrafologiPanelPage() {
  // NOTE: pakai 'as any' karena hd_grafologi_readings belum di lib/types/database.types.ts
  ...
  async function simpanHasil() {
    ...
    if (uploadError) {
      alert('Gagal mengunggah foto. Pastikan bucket "hd-signatures" sudah dibuat di Storage.');
      setSaving(false);
      return;
    }
